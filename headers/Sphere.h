...
protected:
    ...
    uint32_t createVertexData(float* vertices, uint32_t vSize, float *uv, uint32_t uvSize, float *normal, uint32_t nSize, uint32_t * indices, uint32_t iSize,  uint32_t* VBO, uint32_t* EBO);
};
